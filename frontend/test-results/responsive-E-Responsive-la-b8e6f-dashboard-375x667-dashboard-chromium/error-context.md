...
- Name: responsive.spec.js >> E. Responsive layout >> UI-TC-375-dashboard 375x667 dashboard
...
- generic [ref=e3]:
  ...
  - main [ref=e41]:
    - generic [ref=e42]:
      - generic [ref=e43]:
        - paragraph [ref=e44]: Dashboard Overview
        - heading "Welcome back, Nimal" [level=2] [ref=e45]
        - generic [ref=e46]:
          - generic [ref=e47]:
            - generic [ref=e48]: group
            - generic [ref=e49]: 13K
            - generic [ref=e50]: Subscribers
          - generic [ref=e51]:
            - generic [ref=e52]: visibility
            - generic [ref=e53]: 240K
            - generic [ref=e54]: Monthly Views
      - link "auto_awesome Analyze New Content Upload a thumbnail or title to predict performance before publishing. Start Prediction arrow_forward" [ref=e55] [cursor=pointer]:
        - /url: /new-prediction
        - generic:
          - generic [ref=e58]: auto_awesome
          - generic [ref=e60]:
            - heading "Analyze New Content" [level=3] [ref=e61]
            - paragraph [ref=e62]: Upload a thumbnail or title to predict performance before publishing.
          - generic [ref=e63]:
            - text: Start Prediction
            - generic [ref=e64]: arrow_forward
    - generic [ref=e65]:
      - heading "Recent Predictions" [level=3] [ref=e67]
      - generic [ref=e68]:
        - generic [ref=e69]: query_stats
        - paragraph [ref=e70]: No predictions yet — analyze your first piece of content to see it here.
        - link "Create a prediction" [ref=e71] [cursor=pointer]:
          - /url: /new-prediction
```
